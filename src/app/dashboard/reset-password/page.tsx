...
export default async function ResetPasswordPage({searchParams}:{searchParams:Promise<{status?:string;reason?:string}>}){
  ...
  return <div className="admin-login-shell"><div className="admin-login">
    ...
    {status==='error'&&<p role="alert" className="admin-notice is-error">Das hat nicht geklappt{reason?`: ${reason}`:''}. Bitte versuche es nochmals.</p>}
